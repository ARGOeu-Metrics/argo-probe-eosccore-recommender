pipeline {
    agent any
    options {
        checkoutToSubdirectory('argo-probe-eosccore-recommender')
    }
    environment {
        PROJECT_DIR="argo-probe-eosccore-recommender"
                        ...
                        stage ('Test CentOS 7') {
                            steps {
                                ...
                                sh '''
                                    ...
                                    rm -f tests/argo_probe_eosccore_recommender
                                    ln -s $PWD/modules/ tests/argo_probe_eosccore_recommender
